...
**Weitere Pflichten:** Art. 12 BGFA verbietet Interessenkonflikte (lit. c) und erlaubt Werbung nur, wenn sie objektiv bleibt und dem Informationsbedürfnis der Öffentlichkeit entspricht (lit. d). Das Verbot von Erfolgshonoraren (lit. e), die Pflicht zur Berufshaftpflichtversicherung (lit. f), die Übernahme von Pflichtverteidigungen (lit. g), die Vermögenstrennung (lit. h), die Honorartransparenz (lit. i) und die Meldepflicht ans Register (lit. j) ergänzen den Katalog.
